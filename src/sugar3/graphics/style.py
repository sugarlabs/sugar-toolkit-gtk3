...
=======
	...
	Returns double representing fraction of maximum possible screen size
	'''
>>>>>>> 3a2f656... Write documentation for sugar3.graphics.style
    try:
...
<<<<<<< HEAD
    ...
    Args:
        desc (str): a description of the Font object including font
            family, style options, and size (e.g. sans bold 12)
    '''
=======
	'''
	A font defines the style of how the text should be rendered. 
...
=======
		'''
		Returns 4-tuple of red, green, blue, and alpha levels
		'''
        return (self._r, self._g, self._b, self._a)
