...
class ObjectChooser(object):
    ...
    def __init__(self, parent=None, what_filter=None, filter_type=None):
        ...
        filter_type --string
            ...
            will filter based in the 'mime_type' metadata field.

            if is FILTER_TYPE_ACTIVITY, what_filter should by a bundle_id,
            and the object chooser will filter based in the 'activity'
            metadata field.
            ...
            'mime_type' metadata field, and the mime types defined by the
            activity in the activity.info file.
        """
